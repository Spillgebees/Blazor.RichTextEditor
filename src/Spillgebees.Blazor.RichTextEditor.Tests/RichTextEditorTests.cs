...
{
    private const string CreateEditorIdentifier = "Spillgebees.RichTextEditor.createEditor";
    private const string DisposeEditorIdentifier = "Spillgebees.RichTextEditor.disposeEditor";
    private const string SetContentIdentifier = "Spillgebees.RichTextEditor.setContent";
