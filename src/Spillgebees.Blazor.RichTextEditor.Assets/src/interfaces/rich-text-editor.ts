...
interface RichTextEditorNamespace extends EditorFunctions {
  fonts: Set<string>;
...
interface EditorFunctions {
  ...
  getContent(quillContainer: HTMLElement): string | undefined;
  setContent(quillContainer: HTMLElement, content: string): void;
  getSelection(quillContainer: HTMLElement): Range | null | undefined;
  setSelection(quillContainer: HTMLElement, range: Range): void;
  getText(quillContainer: HTMLElement): string | undefined;
...
export type { EditorFunctions, QuillEventHandler, QuillEventNames, RichTextEditorNamespace };
