...
{
    private const string JsNamespace = "Spillgebees.RichTextEditor";
    ...
    private static async ValueTask SafeInvokeVoidAsync(
    ...
    private static async ValueTask<T> SafeInvokeAsync<T>(
        this IJSRuntime jsRuntime,
        ILogger logger,
        string identifier,
        params object?[] args
