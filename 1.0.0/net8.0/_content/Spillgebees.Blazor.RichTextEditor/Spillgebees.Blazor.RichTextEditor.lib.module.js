          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Quill2 = function() {
              ...
              _createClass(Quill3, [{
                ...
                key: "setSelection",
                value: function setSelection2(index, length, source) {
                  if (index == null) {
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            var Editor = function() {
              ...
              _createClass(Editor2, [{
                ...
                key: "getText",
                value: function getText2(index, length) {
...
// node_modules/quill-blot-resizer/dist/main.js
var t = { d: (e2, i2) => {
  for (var s2 in i2)
...
t.d(e, { Z: () => A });
var i = "#0d84fc";
var s = { className: "chrome__overlay", hotKeys: ["ctrlKey"], style: { position: "absolute", border: `1px solid  ${i}` } };
var r = { className: "chromes__resize-grip", enabled: ["all"], style: { position: "absolute", height: "12px", width: "12px", color: i, backgroundColor: "white", boxSizing: "border-box", opacity: "0.80", border: "1px solid", "border-radius": "6px" } };
var o = { resize: true, align: true, inline: true, overlay: s, grips: r };
var n = { chromes: { image: Object.assign(Object.assign({}, o), { overlay: Object.assign(Object.assign({}, s), { className: "image_chrome__overlay" }) }), video: Object.assign(Object.assign({}, o), { overlay: Object.assign(Object.assign({}, s), { className: "video_chrome__overlay" }) }), table: Object.assign(Object.assign({}, o), { inline: false, overlay: Object.assign(Object.assign({}, s), { className: "table_chrome__overlay" }), grips: Object.assign(Object.assign({}, r), { enabled: ["over", "top"] }) }) } };
function h({ constructor: t2 }) {
  return t2;
}
var l = "align";
var a = "left";
...
var u = class {
  constructor() {
    this.lastAlign = a, this.preWidth = 0, this.preRatio = 1, this.alignAttribute = l, this.alignments = { [a]: { name: a, apply: (t2) => {
      this.setAlignment(t2, a), this.setStyle(t2, "inline", "left", "0 1em 1em 0");
    } }, [d]: { name: d, apply: (t2) => {
      this.setAlignment(t2, d), this.setStyle(t2, "block", "block", "auto");
    } }, [p]: { name: p, apply: (t2) => {
      this.setAlignment(t2, p), this.setStyle(t2, "block", "block", "auto", true);
    } }, [c]: { name: c, apply: (t2) => {
      this.setAlignment(t2, c), this.setStyle(t2, "inline", "right", "0 0 1em 1em");
    } } };
  }
  setAlignment(t2, e2) {
    this.lastAlign == p && e2 != this.lastAlign && this.setSize(t2, `${this.preWidth}px`), this.lastAlign = e2, t2.setAttribute(this.alignAttribute, e2);
  }
  setSize(t2, e2) {
    let i2 = t2.getBoundingClientRect();
    this.preWidth = i2.width, this.preRatio = i2.height / i2.width, t2.setAttribute("width", e2), i2 = t2.getBoundingClientRect(), t2.setAttribute("height", i2.width * this.preRatio + "px");
  }
  setStyle(t2, e2, i2, s2, r2) {
    t2.style.setProperty("display", e2), t2.style.setProperty("float", i2), t2.style.setProperty("margin", s2), r2 && this.setSize(t2, "100%");
  }
};
var g = class {
  constructor(t2) {
    this.chromes = t2, this.quill = t2.quill;
  }
  onCreate() {
  }
  onDestroy() {
...
var m = class extends g {
  constructor(t2) {
    var e2, i2;
    super(t2), this.alignHandler = () => {
    }, this.aligner = new u(), this.target = null === (i2 = null === (e2 = this.chromes) || void 0 === e2 ? void 0 : e2.currentChrome) || void 0 === i2 ? void 0 : i2.getTargetElement();
  }
  onCreate() {
    var t2, e2;
    this.toolbar = this.quill.getModule("toolbar"), this.alignHandler = null === (t2 = this.toolbar) || void 0 === t2 ? void 0 : t2.handlers.align, null === (e2 = this.toolbar) || void 0 === e2 || e2.addHandler("align", (t3) => {
      this.setAlignment(t3);
    });
  }
  onDestroy() {
    var t2;
    null === (t2 = this.toolbar) || void 0 === t2 || t2.addHandler("align", this.alignHandler);
  }
  setAlignment(t2) {
    const e2 = t2 || "left";
    this.target && this.aligner.alignments[e2].apply(this.target);
  }
};
var v = class extends g {
  constructor(t2) {
    super(t2), this.onKeyUp = (t3) => {
      this.chromes.currentChrome && ("Delete" === t3.code || "Backspace" === t3.code || 46 === t3.keyCode || t3.keyCode);
    };
  }
  onCreate() {
    document.addEventListener("keyup", this.onKeyUp, true), this.quill.root.addEventListener("input", this.onKeyUp, true);
  }
  onDestroy() {
    document.removeEventListener("keyup", this.onKeyUp), this.quill.root.removeEventListener("input", this.onKeyUp);
  }
};
var b = "chrome-position";
var y = class extends g {
  constructor(t2) {
    var e2;
    super(t2), this.disabled = false, this.onMouseDown = (t3) => {
      if (!(t3.target instanceof HTMLElement))
        return;
      if (this.dragGrip = t3.target, this.setCursor(this.dragGrip.style.cursor), !this.chromes.currentChrome)
        return;
      const e3 = this.chromes.currentChrome.getTargetElement();
      if (!e3)
        return;
      const i3 = e3.getBoundingClientRect();
      this.dragStartX = t3.clientX, this.dragStartY = t3.clientY, this.preDragWidth = i3.width, this.preDragHeight = i3.height, this.targetRatio = i3.height / i3.width, document.addEventListener("mousemove", this.onDrag), document.addEventListener("mouseup", this.onMouseUp);
    }, this.onDrag = (t3) => {
      ...
      if (!e3)
        return;
      const i3 = t3.clientX - this.dragStartX, s2 = t3.clientY - this.dragStartY;
      let r2 = this.preDragWidth, o2 = this.targetRatio * this.preDragWidth;
      this.dragGrip === this.topLeftGrip || this.dragGrip === this.bottomLeftGrip || this.dragGrip == this.leftGrip ? r2 = Math.round(this.preDragWidth - i3) : this.dragGrip !== this.topRightGrip && this.dragGrip !== this.bottomRightGrip && this.dragGrip != this.rightGrip || (r2 = Math.round(this.preDragWidth + i3)), this.dragGrip != this.rightGrip && this.dragGrip != this.leftGrip && (o2 = this.dragGrip == this.bottomGrip ? Math.round(this.preDragHeight + s2) : this.dragGrip == this.topGrip ? Math.round(this.preDragHeight - s2) : this.targetRatio * r2), e3.setAttribute("width", `${r2}px`), e3.setAttribute("height", `${o2}px`), Object.assign(e3.style, { width: `${r2}px` }), this.chromes.update();
    }, this.onMouseUp = () => {
      this.setCursor("auto"), document.removeEventListener("mousemove", this.onDrag), document.removeEventListener("mouseup", this.onMouseUp), this.dragGrip && (this.dragGrip.style.background = "white", this.dragGrip = null);
    };
    const i2 = null == t2 ? void 0 : t2.currentOptions;
    this.gripOptions = null == i2 ? void 0 : i2.grips, t2.overlay && (t2.overlay.className = null !== (e2 = null == i2 ? void 0 : i2.overlay.className) && void 0 !== e2 ? e2 : "", (null == i2 ? void 0 : i2.overlay.style) && Object.assign(t2.overlay.style, i2.overlay.style)), this.topLeftGrip = this.createGrip("top-left"), this.topRightGrip = this.createGrip("top-right"), this.bottomRightGrip = this.createGrip("bottom-right"), this.bottomLeftGrip = this.createGrip("bottom-left"), this.topGrip = this.createGrip("top"), this.rightGrip = this.createGrip("right"), this.bottomGrip = this.createGrip("bottom"), this.leftGrip = this.createGrip("left"), this.dragGrip = null, this.dragStartX = 0, this.dragStartY = 0, this.preDragWidth = 0, this.preDragHeight = 0, this.targetRatio = 0;
  }
  onCreate() {
    var t2, e2, i2, s2;
    this.chromes.overlay.appendChild(this.topLeftGrip), this.chromes.overlay.appendChild(this.topRightGrip), this.chromes.overlay.appendChild(this.bottomRightGrip), this.chromes.overlay.appendChild(this.bottomLeftGrip), this.chromes.overlay.appendChild(this.topGrip), this.chromes.overlay.appendChild(this.leftGrip), this.chromes.overlay.appendChild(this.bottomGrip), this.chromes.overlay.appendChild(this.rightGrip), this.repositionHandles(null !== (e2 = null === (t2 = this.gripOptions) || void 0 === t2 ? void 0 : t2.style) && void 0 !== e2 ? e2 : {}), this.observer = new MutationObserver((t3) => {
      t3.forEach((t4) => {
        var e3, i3;
        if ("attributes" == t4.type && t4.attributeName == l) {
          this.chromes.repositionOverlay();
          const t5 = null === (i3 = null === (e3 = this.chromes.currentChrome) || void 0 === e3 ? void 0 : e3.getTargetElement()) || void 0 === i3 ? void 0 : i3.getAttribute(l);
          switch ("justify" != t5 && this.disabled && this.enableAll(), t5) {
            case "right":
              this.disableGrip(this.rightGrip), this.enableGrip(this.bottomGrip), this.enableGrip(this.leftGrip);
              break;
            case "left":
              this.enableGrip(this.rightGrip), this.enableGrip(this.bottomGrip), this.disableGrip(this.leftGrip);
              break;
            case "center":
              this.enableGrip(this.rightGrip), this.enableGrip(this.bottomGrip), this.enableGrip(this.leftGrip);
              break;
            default:
              this.disableAll(), this.enableGrip(this.bottomGrip);
          }
        }
      });
    });
    const r2 = null === (s2 = null === (i2 = this.chromes) || void 0 === i2 ? void 0 : i2.currentChrome) || void 0 === s2 ? void 0 : s2.getTargetElement();
    r2 && this.observer.observe(r2, { attributes: true });
  }
  onDestroy() {
    var t2;
    this.setCursor("auto"), this.chromes.overlay.removeChild(this.topLeftGrip), this.chromes.overlay.removeChild(this.topRightGrip), this.chromes.overlay.removeChild(this.bottomRightGrip), this.chromes.overlay.removeChild(this.bottomLeftGrip), this.chromes.overlay.removeChild(this.topGrip), this.chromes.overlay.removeChild(this.leftGrip), this.chromes.overlay.removeChild(this.bottomGrip), this.chromes.overlay.removeChild(this.rightGrip), null === (t2 = this.observer) || void 0 === t2 || t2.disconnect();
  }
  createGrip(t2) {
    var e2, i2;
    let s2 = document.createElement("div");
    const r2 = null === (e2 = this.gripOptions) || void 0 === e2 ? void 0 : e2.className;
    return r2 && s2.classList.add(r2), s2.setAttribute(b, t2), (null === (i2 = this.gripOptions) || void 0 === i2 ? void 0 : i2.style) && Object.assign(s2.style, this.gripOptions.style), this.enableGrip(s2), s2.addEventListener("mouseout", () => {
      s2 != this.dragGrip && (s2.style.background = "white");
    }), s2.addEventListener("mouseover", () => {
      "disable" != s2.getAttribute("handled") && (this.dragGrip && s2 != this.dragGrip || (s2.style.background = "#0d84fcb0"));
    }), s2;
  }
  repositionHandles(t2) {
    let e2 = "0px", i2 = "0px";
    t2 && (t2.width && (e2 = -parseFloat(t2.width) / 2 - 1 + "px"), t2.height && (i2 = -parseFloat(t2.height) / 2 - 1 + "px")), Object.assign(this.topLeftGrip.style, { left: e2, top: i2 }), Object.assign(this.topRightGrip.style, { right: e2, top: i2 }), Object.assign(this.bottomRightGrip.style, { right: e2, bottom: i2 }), Object.assign(this.bottomLeftGrip.style, { left: e2, bottom: i2 }), Object.assign(this.topGrip.style, { left: "50%", "margin-left": e2, top: i2 }), Object.assign(this.leftGrip.style, { left: e2, top: "50%", "margin-top": i2 }), this.disableGrip(this.leftGrip), Object.assign(this.rightGrip.style, { right: e2, top: "50%", "margin-top": i2 }), Object.assign(this.bottomGrip.style, { left: "50%", "margin-left": e2, bottom: i2 });
  }
  checkEnableGrip(t2) {
    var e2, i2, s2, r2, o2;
    const n2 = t2.getAttribute(b);
    if (null === (i2 = null === (e2 = this.gripOptions) || void 0 === e2 ? void 0 : e2.enabled) || void 0 === i2 ? void 0 : i2.includes("all"))
      return true;
    const h2 = !(null === (s2 = this.gripOptions) || void 0 === s2 ? void 0 : s2.enabled.includes("over"));
    return h2 && (null === (r2 = this.gripOptions) || void 0 === r2 ? void 0 : r2.enabled.includes(n2)) || !h2 && !(null === (o2 = this.gripOptions) || void 0 === o2 ? void 0 : o2.enabled.includes(n2));
  }
  enableGrip(t2) {
    t2 && this.checkEnableGrip(t2) && (t2.setAttribute("handled", "enable"), t2.addEventListener("mousedown", this.onMouseDown), Object.assign(t2.style, { border: "1px solid  #0d84fc", cursor: this.getCursor(t2) }));
  }
  disableGrip(t2) {
    t2 && this.checkEnableGrip(t2) && (t2.setAttribute("handled", "disable"), t2.removeEventListener("mousedown", this.onMouseDown), Object.assign(t2.style, { border: "1px solid rgb(156 156 156)", cursor: null }));
  }
  enableAll() {
    this.enableGrip(this.topLeftGrip), this.enableGrip(this.topRightGrip), this.enableGrip(this.bottomRightGrip), this.enableGrip(this.bottomLeftGrip), this.enableGrip(this.topGrip), this.enableGrip(this.leftGrip), this.enableGrip(this.bottomGrip), this.enableGrip(this.rightGrip), this.disabled = false;
  }
  disableAll() {
    this.disableGrip(this.leftGrip), this.disableGrip(this.bottomGrip), this.disableGrip(this.rightGrip), this.disableGrip(this.topLeftGrip), this.disableGrip(this.topRightGrip), this.disableGrip(this.bottomRightGrip), this.disableGrip(this.bottomLeftGrip), this.disabled = true;
  }
  getCursor(t2) {
    switch (t2.getAttribute(b)) {
      case "top":
      case "bottom":
        return "ns-resize";
      case "right":
  ...
  setCursor(t2) {
    if (document.body && (document.body.style.cursor = t2), this.chromes.currentChrome) {
      const e2 = this.chromes.currentChrome.getOverlayElement();
      e2 && (e2.style.cursor = t2);
    }
  }
};
var G = class {
...
var f = "data-blot-chromes-unhandled-bound";
var x = class extends G {
  constructor(t2, e2) {
    super(t2), this.onTextChange = () => {
      Array.from(document.querySelectorAll(`${this.selector}:not([${f}])`)).forEach((t3) => {
        t3.setAttribute(f, "true"), t3.addEventListener("mouseenter", this.onMouseEnter);
      });
    }, this.onMouseEnter = (t3) => {
      const e3 = t3.target;
      e3 instanceof HTMLElement && (this.nextUnhandled = e3, this.repositionProxyImage(this.nextUnhandled));
    }, this.onProxyImageClick = () => {
      this.unhandled = this.nextUnhandled, this.nextUnhandled = null, this.chromes.show(this), this.hideProxyImage();
    }, this.selector = e2, this.unhandled = null, this.nextUnhandled = null;
  }
  init() {
    var t2;
    document.body && document.body.appendChild(this.createProxyImage()), this.hideProxyImage(), null === (t2 = this.proxyImage) || void 0 === t2 || t2.addEventListener("click", this.onProxyImageClick), this.quill.on("text-change", this.onTextChange);
  }
  getTargetElement() {
    var t2;
    return null !== (t2 = this.unhandled) && void 0 !== t2 ? t2 : HTMLElement.prototype;
  }
  getOverlayElement() {
    var t2;
    return null !== (t2 = this.unhandled) && void 0 !== t2 ? t2 : HTMLElement.prototype;
  ...
  onHide() {
    this.hideProxyImage(), this.nextUnhandled = null, this.unhandled = null;
  }
  createProxyImage() {
    const t2 = document.createElement("canvas"), e2 = t2.getContext("2d");
    return e2 && (e2.globalAlpha = 0, e2.fillRect(0, 0, 1, 1)), this.proxyImage = document.createElement("img"), this.proxyImage.src = t2.toDataURL("image/png"), this.proxyImage.classList.add("blot-chromes__proxy-image"), Object.assign(this.proxyImage.style, { position: "absolute", margin: "0" }), this.proxyImage;
  }
  hideProxyImage() {
    this.proxyImage && Object.assign(this.proxyImage.style, { display: "none" });
  }
  repositionProxyImage(t2) {
    const e2 = t2.getBoundingClientRect();
    this.proxyImage && Object.assign(this.proxyImage.style, { display: "block", left: `${e2.left + window.pageXOffset}px`, top: `${e2.top + window.pageYOffset}px`, width: `${e2.width}px`, height: `${e2.height}px` });
  }
};
var C = class extends g {
  constructor(t2) {
    var e2;
    super(t2), this.pageX = 0, this.grips = [], this.onWindowResize = (t3) => {
    }, this.onMouseEnter = (t3) => {
      var e3;
      if (!(t3.target instanceof HTMLDivElement))
        return;
      const i2 = t3.target;
      (null === (e3 = this.row) || void 0 === e3 ? void 0 : e3.parentNode).childNodes.forEach((t4) => {
        let e4 = t4.children[i2.index];
        Object.assign(e4.style, { "border-right": "1px solid #0d84fc" });
      });
    }, this.onMouseOut = (t3) => {
      var e3;
      if (!(t3.target instanceof HTMLDivElement))
      ...
      (null === (e3 = this.row) || void 0 === e3 ? void 0 : e3.parentNode).childNodes.forEach((t4) => {
        let e4 = t4.children[i2.index];
        Object.assign(e4.style, { "border-right": "" });
      });
    }, this.documentMouseMove = (t3) => {
      var e3, i2;
      if (this.curGrip) {
        const s2 = t3.pageX - this.pageX + 6, r2 = this.absoluteWidth(this.curGrip.endLeft) + s2, o2 = this.curGrip.prev ? this.curGrip.prev.offsetLeft : this.absoluteWidth(this.curGrip.startShift), n2 = this.curGrip.next ? this.curGrip.next.offsetLeft : this.chromes.overlay.offsetWidth;
        if (s2 > 0 ? r2 < n2 - 26 : r2 > o2 + 26) {
          const t4 = this.curGrip.next ? this.curGrip.next.index : this.curGrip.index + 1;
          let o3 = null === (e3 = this.row) || void 0 === e3 ? void 0 : e3.children[t4];
          const n3 = this.curGrip.next ? this.absoluteWidth(this.curGrip.next.endLeft - this.curGrip.next.startShift) : this.chromes.overlay.offsetWidth - this.absoluteWidth(this.curGrip.endLeft), h2 = this.percentWidth(n3 - s2 - 1);
          null == o3 || o3.setAttribute("width", `${h2}%`);
          let l2 = null === (i2 = this.row) || void 0 === i2 ? void 0 : i2.children[this.curGrip.index];
          const a2 = this.curGrip.endLeft - this.curGrip.startShift + +this.percentWidth(s2);
          null == l2 || l2.setAttribute("width", `${a2}%`), this.curGrip.style.left = `${this.percentWidth(r2)}%`;
        }
      }
    }, this.documentMouseUp = (t3) => {
      this.curGrip && (this.curGrip.endLeft = +this.curGrip.style.left.replace("%", ""), this.curGrip.next && (this.curGrip.next.startShift = this.curGrip.endLeft), this.curGrip = void 0);
    }, this.onMouseDown = (t3) => {
      t3.target instanceof HTMLElement && (this.curGrip = t3.target, this.curGrip.endLeft = +this.percentWidth(t3.target.offsetLeft), this.curGrip.next && (this.curGrip.next.startShift = this.curGrip.endLeft), this.pageX = t3.pageX);
    }, this.table = null === (e2 = t2.currentChrome) || void 0 === e2 ? void 0 : e2.getTargetElement(), this.boundsWidth = t2.overlay.clientWidth, t2.quillRoot, t2.quillRootContainer.clientWidth, t2.quillRootContainer.offsetLeft, this.chromes = t2;
  }
  onCreate() {
    var t2, e2, i2;
    if (this.row = null === (t2 = this.table) || void 0 === t2 ? void 0 : t2.getElementsByTagName("tr")[0], !this.row)
      return;
    const s2 = this.row.children;
    if (!s2)
      return;
    let r2 = 0;
    const o2 = null !== (i2 = null === (e2 = this.table) || void 0 === e2 ? void 0 : e2.clientHeight) && void 0 !== i2 ? i2 : 0;
    let n2 = null;
    for (let t3 = 0; t3 < s2.length - 1; t3++) {
      var h2 = s2[t3].offsetWidth;
      const e3 = this.createGrip(o2, n2, { index: t3, startShift: +this.percentWidth(r2), endLeft: +this.percentWidth(r2 + h2) });
      n2 = e3, r2 += h2, this.chromes.overlay.appendChild(e3), this.setListeners(e3), this.grips.push(e3);
    }
  }
  onDestroy() {
    for (document.removeEventListener("mousemove", this.documentMouseMove), document.removeEventListener("mouseup", this.documentMouseUp), this.grips.forEach((t2) => this.chromes.overlay.removeChild(t2)); this.grips.length; ) {
      const t2 = this.grips.pop();
      null == t2 || t2.removeEventListener("mousedown", this.onMouseDown), null == t2 || t2.removeEventListener("mouseover", this.onMouseEnter), null == t2 || t2.removeEventListener("mouseout", this.onMouseOut);
    }
  }
  clearReplaceGrip(t2) {
    var e2;
    const i2 = t2.cloneNode(true);
    null === (e2 = null == t2 ? void 0 : t2.parentNode) || void 0 === e2 || e2.replaceChild(t2, i2);
  }
  onUpdate() {
  }
  createGrip(t2, e2, i2) {
    const s2 = document.createElement("div"), r2 = Object.assign(s2, Object.assign(Object.assign({}, i2), { prev: e2, next: null })), o2 = { display: "inline", top: 0, width: "6px", position: "absolute", cursor: "col-resize", userSelect: "none", height: `${t2}px`, "margin-left": "-4px", left: `${i2.endLeft}%` };
    return Object.assign(r2.style, o2), e2 && (e2.next = r2), r2;
  }
  setListeners(t2) {
    t2.addEventListener("mousedown", this.onMouseDown), t2.addEventListener("mouseover", this.onMouseEnter), t2.addEventListener("mouseout", this.onMouseOut), document.addEventListener("mousemove", this.documentMouseMove), document.addEventListener("mouseup", this.documentMouseUp);
  }
  percentWidth(t2) {
    return (100 * t2 / this.chromes.overlay.offsetWidth).toFixed(2);
  }
  absoluteWidth(t2) {
    return t2 / 100 * this.chromes.overlay.offsetWidth;
  }
  paddingDiff(t2) {
    if ("border-box" == this.getStyleVal(t2, "box-sizing"))
      return 0;
    const e2 = this.getStyleVal(t2, "padding-left"), i2 = this.getStyleVal(t2, "padding-right");
    return parseInt(e2) + parseInt(i2);
  }
  getStyleVal(t2, e2) {
    return window.getComputedStyle(t2, null).getPropertyValue(e2);
  }
};
var E = ["alt", "height", "width", "style", "align"];
var L = /* @__PURE__ */ new Map([["image", class extends G {
  constructor(t2) {
    super(t2), this.onClick = (t3) => {
      const e2 = t3.target;
      e2 instanceof HTMLImageElement && "IMG" === e2.tagName && (this.img = e2, this.chromes.show(this));
    }, this.img = null, this.chromes = t2;
  }
  init() {
  ...
  getTargetElement() {
    var t2;
    return null !== (t2 = this.img) && void 0 !== t2 ? t2 : HTMLElement.prototype;
  }
  onHide() {
    this.img = null;
  }
}], ["video", class extends x {
  constructor(t2) {
    super(t2, "iframe.ql-video");
  }
}], ["table", class extends G {
  constructor(t2) {
    super(t2), this.overHooks = [], this.ctrlHooks = [m, C, y, v], this.currentHooks = [], this.onClick = (t3) => {
      const e2 = t3.target;
      e2 instanceof HTMLElement && "TD" === e2.tagName && (this.currentHooks = t3.ctrlKey ? this.ctrlHooks : this.overHooks, this.currentHooks.length && (this.table = e2.closest("table"), this.chromes.show(this)));
    }, this.table = null, this.chromes = t2;
  }
  getActions() {
  ...
  getTargetElement() {
    var t2;
    return null !== (t2 = this.table) && void 0 !== t2 ? t2 : HTMLElement.prototype;
  }
  onHide() {
    this.table = null;
  }
...
var O = class {
  constructor(t2, e2) {
    this.quill = t2, this.options = Object.assign(n, e2);
  }
};
var w = document.ondragstart;
var k = class extends O {
  constructor(t2, e2) {
    super(t2, e2), this.chromeOption = /* @__PURE__ */ new Map(), this.onClick = () => {
      this.hide();
    }, this.registerImage(h(t2)), this.quillRoot = this.quill.root, this.quillRootContainer = this.quillRoot.parentNode, this.currentChrome = null, this.hooks = [], this.overlay = document.createElement("div"), document.execCommand("enableObjectResizing", false, "false"), this.quillRootContainer.style.position = this.quillRootContainer.style.position || "relative", this.quill.root.addEventListener("click", this.onClick);
    const i2 = Object.keys(this.options.chromes), s2 = Object.values(this.options.chromes);
    i2.map((t3, e3) => {
      const i3 = L.get(t3);
      i3 && this.chromeOption.set(i3, s2[e3]);
    }), this.chromes = i2.map((t3) => new (L.get(t3))(this)), this.chromes.forEach((t3) => t3.init());
  }
  registerImage(t2) {
    const e2 = t2.import("formats/image");
    t2.register(class extends e2 {
      static formats(t3) {
        return E.reduce(function(e3, i2) {
          var s2;
          return t3.hasAttribute(i2) && (e3[i2] = null !== (s2 = t3.getAttribute(i2)) && void 0 !== s2 ? s2 : ""), e3;
        }, {});
      }
      format(t3, e3) {
        E.indexOf(t3) > -1 ? e3 ? this.domNode.setAttribute(t3, e3) : this.domNode.removeAttribute(t3) : super.format(t3, e3);
      }
    }, true);
  }
  show(t2) {
    this.currentChrome = t2, this.currentOptions = this.chromeOption.get(h(t2)), this.currentChrome.setSelection(), this.setUserSelect("none"), this.quillRootContainer.appendChild(this.overlay), this.repositionOverlay(), this.createActions(t2);
  }
  hide() {
    this.currentChrome && (this.currentChrome.onHide(), this.currentChrome = null, this.quillRootContainer.removeChild(this.overlay), this.overlay.style.setProperty("display", "none"), this.setUserSelect(""), this.destroyActions());
  }
  update() {
    this.repositionOverlay(), this.hooks.forEach((t2) => t2.onUpdate());
  }
  createActions(t2) {
    this.hooks = t2.getActions().map((t3) => {
      const e2 = new t3(this);
      return e2.onCreate(), e2;
    }), document.addEventListener("dragstart", (t3) => (t3.preventDefault(), document.body.style.cursor = "auto", false));
  }
  destroyActions() {
    this.hooks.forEach((t2) => t2.onDestroy()), this.hooks = [], document.ondragstart = w;
  }
  repositionOverlay() {
    if (!this.currentChrome)
      return;
    const t2 = this.currentChrome.getOverlayElement();
    if (!t2)
      return;
    const e2 = this.quillRootContainer, i2 = t2.getBoundingClientRect(), s2 = e2.getBoundingClientRect();
    Object.assign(this.overlay.style, { display: "block", "margin-left": `${i2.left - s2.left - 1 + e2.scrollLeft}px`, top: `${i2.top - s2.top + e2.scrollTop}px`, width: `${i2.width}px`, height: `${i2.height}px` });
  }
  setUserSelect(t2) {
    ["userSelect", "mozUserSelect", "webkitUserSelect", "msUserSelect"].forEach((e2) => {
      this.quill.root.style.setProperty(e2, t2), document.documentElement && document.documentElement.style.setProperty(e2, t2);
    });
  }
};
k.DEFAULTS = n;
...
(function(DotNet2) {
  ...
  class JSObject {
    ...
    constructor(_jsObject) {
      ...
      this._cachedFunctions = /* @__PURE__ */ new Map();
    }
  ...
  DotNet2.attachDispatcher = attachDispatcher;
  function attachReviver(reviver) {
    jsonRevivers.push(reviver);
  }
  DotNet2.attachReviver = attachReviver;
  ...
  DotNet2.invokeMethod = invokeMethod;
  ...
  DotNet2.invokeMethodAsync = invokeMethodAsync;
  ...
  DotNet2.createJSObjectReference = createJSObjectReference;
  function createJSStreamReference(streamReference) {
    ...
    if (streamReference instanceof Blob) {
      ...
      if (streamReference.byteLength === void 0) {
  ...
  DotNet2.createJSStreamReference = createJSStreamReference;
  ...
  DotNet2.disposeJSObjectReference = disposeJSObjectReference;
  ...
  (function(JSCallResultType2) {
    JSCallResultType2[JSCallResultType2["Default"] = 0] = "Default";
    JSCallResultType2[JSCallResultType2["JSObjectReference"] = 1] = "JSObjectReference";
    JSCallResultType2[JSCallResultType2["JSStreamReference"] = 2] = "JSStreamReference";
    JSCallResultType2[JSCallResultType2["JSVoidResult"] = 3] = "JSVoidResult";
  })(JSCallResultType = DotNet2.JSCallResultType || (DotNet2.JSCallResultType = {}));
  class CallDispatcher {
    // eslint-disable-next-line no-empty-function
    constructor(_dotNetCallDispatcher) {
      this._dotNetCallDispatcher = _dotNetCallDispatcher;
      this._byteArraysToBeRevived = /* @__PURE__ */ new Map();
      this._pendingDotNetToJSStreams = /* @__PURE__ */ new Map();
    ...
    invokeJSFromDotNet(identifier, argsJson, resultType, targetInstanceId) {
      ...
      return result === null || result === void 0 ? null : stringifyArgs(this, result);
    }
    beginInvokeJSFromDotNet(asyncHandle, identifier, argsJson, resultType, targetInstanceId) {
      ...
      if (asyncHandle) {
        promise.then((result) => stringifyArgs(this, [
          asyncHandle,
          true,
    ...
    endInvokeDotNetFromJS(asyncCallId, success, resultJsonOrExceptionMessage) {
      const resultOrError = success ? parseJsonWithRevivers(this, resultJsonOrExceptionMessage) : new Error(resultJsonOrExceptionMessage);
...
${error.stack}`;
  ...
  DotNet2.findJSFunction = findJSFunction;
  function disposeJSObjectReferenceById(id) {
    delete cachedJSObjectsById[id];
  }
  DotNet2.disposeJSObjectReferenceById = disposeJSObjectReferenceById;
  class DotNetObject {
    // eslint-disable-next-line no-empty-function
  ...
  DotNet2.DotNetObject = DotNetObject;
...
// src/interfaces/quill-events.ts
var TextChangedEvent = class {
  constructor(source) {
    this.source = source;
  }
  source;
};
var SelectionChangedEvent = class {
  constructor(oldRange, newRange, source) {
...
// src/debouncer.ts
function debounce(func, debounceIntervalInMilliseconds) {
  let timeout;
...
function bootstrap() {
  ...
  window.Spillgebees.fonts = window.Spillgebees.fonts || /* @__PURE__ */ new Set();
  window.Spillgebees.editorFunctions = window.Spillgebees.editorFunctions || {
    ...
    deregisterQuillEventCallback
  };
  window.Spillgebees.eventMap = window.Spillgebees.eventMap || /* @__PURE__ */ new Map();
}
var createEditor = async (dotNetHelper, quillContainer, toolbar, isEditorEnabled, shouldRegisterEventCallbacks, placeholder, theme, debugLevel, fonts = new Array(), eventDebounceIntervalInMilliseconds = 500) => {
  import_quill.default.register("modules/blotFormatter", M);
  if (fonts.length > 0) {
    window.Spillgebees.fonts = [...window.Spillgebees.fonts, ...fonts];
    let fontAttributor = import_quill.default.import("formats/font");
  ...
  let quill = new import_quill.default(quillContainer, quillOptions);
  window.Spillgebees.eventMap.set(quill, /* @__PURE__ */ new Map());
...
var getContent = (quillReference) => quillReference.__quill?.root.innerHTML;
var setContent = (quillReference, content) => quillReference.__quill.setContents(quillReference.__quill.clipboard.convert(content), "api");
var getSelection = (quillReference) => quillReference.__quill?.getSelection();
var setSelection = (quillReference, range) => quillReference.__quill?.setSelection(range);
var getText = (quillReference) => quillReference.__quill?.getText();
var insertImage = (quillReference, imageUrl) => {
  let editorIndex = quillReference.__quill?.getSelection()?.index ?? 0;
  return quillReference.__quill?.updateContents(
    new import_quill_delta.default().retain(editorIndex).insert(
      { image: imageUrl },
      { alt: imageUrl }
    )
  );
};
var setEditorEnabledState = (quillReference, isEditorEnabled) => quillReference.__quill?.enable(isEditorEnabled);
var disposeEditor = async (quillReference) => {
...
var registerQuillEventCallback = async (quill, invokableDotNetMethodName, eventName, dotNetHelper, debounceIntervalInMilliseconds) => {
  ...
  if (eventName === "text-change") {
    let handler = async (_delta, _oldContents, source) => await dotNetHelper.invokeMethodAsync(invokableDotNetMethodName, new TextChangedEvent(source));
    ...
    let handler = async (range, oldRange, source) => await dotNetHelper.invokeMethodAsync(invokableDotNetMethodName, new SelectionChangedEvent(oldRange, range, source));
    let debouncedHandler = debounce(handler, debounceIntervalInMilliseconds);
    window.Spillgebees.eventMap.get(quill)?.set(eventName, debouncedHandler);
...
var deregisterQuillEventCallback = async (quillReference, eventName) => {
  ...
  if (eventName === "text-change") {
    ...
    quillReference.__quill.off("text-change", handler);
  } else if (eventName === "selection-change") {
    let handler = window.Spillgebees.eventMap.get(quillReference.__quill).get(eventName);
    window.Spillgebees.eventMap.get(quillReference.__quill)?.delete(eventName);
    quillReference.__quill.off("selection-change", handler);
  } else {
    throw new Error(`Invalid eventName: ${eventName}`);
  }
};
...
// src/index.ts
function beforeWebStart(options) {
  if (window.hasBeforeStartBeenCalled) {
    return;
  }
  beforeStart(options);
}
function afterWebStarted(options) {
  if (window.hasAfterStartedBeenCalled) {
    return;
  }
  afterStarted(options);
}
function beforeWebAssemblyStart(options) {
  if (window.hasBeforeStartBeenCalled) {
    return;
  }
  beforeStart(options);
}
function afterWebAssemblyStarted(options) {
  if (window.hasAfterStartedBeenCalled) {
    return;
  }
  afterStarted(options);
}
function beforeServerStart(options) {
  if (window.hasBeforeStartBeenCalled) {
    return;
  }
  beforeStart(options);
}
function afterServerStarted(options) {
  if (window.hasAfterStartedBeenCalled) {
    return;
  }
  afterStarted(options);
}
function beforeStart(_) {
  window.hasBeforeStartBeenCalled = true;
  bootstrap();
}
function afterStarted(_) {
...
quill/dist/quill.js:
   ...
   *)
*/
//# sourceMappingURL=Spillgebees.Blazor.RichTextEditor.lib.module.js.map
